...
class Chatbot extends Component {
    ...
    render() {
        if (this.state.showBot) {
            return (
                <div style={{ minHeight: 500, maxHeight: 470, width:400, position: 'left', bottom: 0, right: 0, border: '1px solid lightgray'}}>
                    <nav>
            ...
            return (
                <div style={{ minHeight: 40, maxHeight: 500, width:400, position: 'center', bottom: 0, right: 0, border: '1px solid lightgray'}}>
                    <nav>
                        <div className="nav-wrapper">
                            <a href="/" className="brand-logo">ChatBot</a>
                            <ul id="nav-mobile" className="right hide-on-med-and-down">
